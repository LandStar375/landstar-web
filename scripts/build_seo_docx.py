...
INPUT_PATH = ROOT / "docs" / "seo-keywords-metadata-content.md"
OUTPUT_PATH = ROOT / "docs" / "star-rental-seo-keywords-metadata-content.docx"
...
def build_document_xml(markdown_text: str) -> str:
    ...
    for raw_line in markdown_text.splitlines():
        ...
        if line.startswith("# "):
            ...
            parts.append(make_paragraph(f"Generated on {generated}."))
            continue
        if line.startswith("## "):
...
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties"
  ...
  <dc:title>Star Rental SEO Keywords, Metadata and Content</dc:title>
  <dc:creator>Star Rental</dc:creator>
  <cp:lastModifiedBy>Star Rental</cp:lastModifiedBy>
...
<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties"
  ...
  <Application>Star Rental</Application>
</Properties>
"""
